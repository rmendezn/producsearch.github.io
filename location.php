...
<header class="w3-container w3-theme w3-padding" id="myHeader">
  ...
  <div class="w3-center">
  <h4>You can search by Name and Code of Product.</h4>
...
<script type="text/javascript">
          ...
          success: function(response){
            console.log(response);
              ...
              for(var i=0; i<len; i++){
                  ...
                  $('#frmprodlista').append('<option id="'+id+'||'+code+'||'+product+' - ['+code+']" value="'+product+' - ['+code+']" ></option>');
              }
          }
      });

      $(document).on('change', '#frmprod', function(){
              var optionslist = $('datalist')[0].options;
              var value = $('#frmprod').val();
              for (var x=0;x<optionslist.length;x++){
                var cadena = optionslist[x].id.split("||");
    ...
    function cambio(){
      console.log("Si entro con el click"); 
      var com = $('#frmprod').val();
